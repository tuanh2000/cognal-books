...
const KEEP_TERM_EXAMPLES = [
  ...
  'container',
  'cloud',
  // Core programming vocabulary a developer always reads in English.
  'interface',
  'package',
  'class',
  'object',
...
export class TranslationService {
  ...
  async *stream(
    ...
    const system = [
      ...
      'They already know programming terminology in English, so common programming and computing',
      'terms must stay in English — translating them only makes the text harder for this reader.',
      'Rules:',
      ...
      '  terms (e.g. interface, package, class, object, function, method, variable, array,',
      '  thread, cache, compiler, framework, database), product and brand names, proper nouns,',
      '  acronyms, file/format names, and any code, identifiers, or keywords.',
      ...
      '  to "phần mềm", or "interface" to "giao diện").',
  ...
  async *discuss(
    ...
    const system = [
      ...
      '  Common programming terms (interface, package, class, function, etc.) must stay in',
      '  English — the reader knows them and translating them only adds friction.',
